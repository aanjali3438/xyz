...
<table class="table table-responsive">
				...
				<td><a href="bDescription?bid={{field.bid}}">{{field.bid}}<a/></td>
				<td><a href="bDescription?bid={{field.bid}}">{{field.bname}}<a/></td>
				<td><a href="bDescription?bid={{field.bid}}">{{field.fname}}</a></td>
			    
				<td><a href="bDescription?bid={{field.bid}}"><img src="./resources/My_Design/Bimages/{{field.bid}}.jpg" height="50px" 
                     width="50px"></a></td>	
