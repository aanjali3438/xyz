...
<table class="table table-responsive" >
				...
				<td><a href="dDescription?did={{field.did}}">{{field.did}}</a></td>
				<td><a href="dDescription?did={{field.did}}">{{field.dname}}</a></td>
				<td><a href="dDescription?did={{field.did}}">{{field.bname}}</a></td>
				<td><a href="dDescription?did={{field.did}}">{{field.fname}}</a></td>
		        <td><a href="dDescription?did={{field.did}}">{{field.price}}</a></td>
				<td><a href="dDescription?did={{field.did}}"><img src="./resources/My_Design/Dimages/{{field.did}}.jpg" height="50px" 
                     width="50px"></a></td>
